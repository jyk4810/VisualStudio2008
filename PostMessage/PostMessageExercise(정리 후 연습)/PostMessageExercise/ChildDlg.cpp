...
{
	m_pParentDlg = NULL;
	m_pParentDlg = (CPostMessageExerciseDlg*)AfxGetMainWnd();
	m_strName		 = "";
	m_Struct.Name = "";
	m_Struct.Value = "";
}
...
void CChildDlg::OnCbnSelchangeComboIntegername()
{
	...
	SetDlgItemText(IDC_EDIT_INTEGERVALUE, m_Struct.Value);
	//m_pParentDlg->PostMessage(USER_MESSAGE_SET_VALUE, VALUE_TYPE_INTEGER, (LPARAM)&m_Struct); // staticText에 정보 show
}
void CChildDlg::OnCbnSelchangeComboFloatname()
{
	...
	SetDlgItemText(IDC_EDIT_FLOATVALUE, m_Struct.Value);
//	m_pParentDlg->PostMessage(USER_MESSAGE_SET_VALUE, VALUE_TYPE_FLOAT, (LPARAM)&m_Struct); // staticText에 정보 show
}
void CChildDlg::OnCbnSelchangeComboEnumname()
{
	...
	SetDlgItemText(IDC_EDIT_ENUMVALUE, m_Struct.Value);
//	m_pParentDlg->PostMessage(USER_MESSAGE_SET_VALUE, VALUE_TYPE_ENUMERATION, (LPARAM)&m_Struct);
}
void CChildDlg::OnCbnSelchangeComboComname()
{
	...
	SetDlgItemText(IDC_EDIT_COMVALUE, m_Struct.Value);
//	m_pParentDlg->PostMessage(USER_MESSAGE_SET_VALUE, VALUE_TYPE_COMMAND, (LPARAM)&m_Struct);
}
void CChildDlg::OnCbnSelchangeComboStrname()
{
	...
	SetDlgItemText(IDC_EDIT_STRVALUE, m_Struct.Value);
//	m_pParentDlg->PostMessage(USER_MESSAGE_SET_VALUE, VALUE_TYPE_STRING, (LPARAM)&m_Struct);
}
void CChildDlg::OnCbnSelchangeComboBlnname()
{
	...
	SetDlgItemText(IDC_EDIT_BLNVALUE, m_Struct.Value);
//	m_pParentDlg->PostMessage(USER_MESSAGE_SET_VALUE, VALUE_TYPE_BOOLEAN, (LPARAM)&m_Struct);
}
...
//	m_pParentDlg->PostMessage(USER_MESSAGE_SET_VALUE, VALUE_TYPE_ENUMERATION, (LPARAM)&m_Struct); // staticText에 정보 show
...
//	m_pParentDlg->PostMessage(USER_MESSAGE_SET_VALUE, VALUE_TYPE_COMMAND, (LPARAM)&m_Struct); // staticText에 정보 show
...
//	m_pParentDlg->PostMessage(USER_MESSAGE_SET_VALUE, VALUE_TYPE_STRING, (LPARAM)&m_Struct); // staticText에 정보 show
...
//	m_pParentDlg->PostMessage(USER_MESSAGE_SET_VALUE, VALUE_TYPE_BOOLEAN, (LPARAM)&m_Struct); // staticText에 정보 show
